...
from 
  signups
full join
  app_downloads on app_downloads.app_download_key=signups.session_id
full join 
  ride_requests on signups.user_id=ride_requests.user_id
group by
  1,2,3,4,5),
...
from 
  ride_requests
full join
  signups on ride_requests.user_id=signups.user_id
full join
  app_downloads on app_downloads.app_download_key=signups.session_id
group by 
  1,2,3,4,5),
...
from
  transactions
full join
  ride_requests on transactions.ride_id=ride_requests.ride_id
full join
  signups on ride_requests.user_id=signups.user_id
full join
  app_downloads on app_downloads.app_download_key=signups.session_id
...
from 
  reviews
full join 
  signups on signups.user_id=reviews.user_id
full join
  app_downloads on app_downloads.app_download_key=signups.session_id
group by 
  1,2,3,4,5)
...
full join 
  app_downloads on app_downloads.app_download_key=signups.session_id
full join 
  transactions on transactions.ride_id=ride_requests.ride_id
group by
  1,3
order by
  1,3
